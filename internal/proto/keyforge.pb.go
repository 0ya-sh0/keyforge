...
var file_keyforge_proto_rawDesc = []byte{
	...
	0x2e, 0x63, 0x6f, 0x6d, 0x2f, 0x30, 0x79, 0x61, 0x2d, 0x73, 0x68, 0x30, 0x2f, 0x69, 0x6e, 0x74,
...
var file_keyforge_proto_goTypes = []interface{}{
...
func file_keyforge_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_keyforge_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_keyforge_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
		...
		file_keyforge_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
		...
		file_keyforge_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
		...
		file_keyforge_proto_msgTypes[4].Exporter = func(v interface{}, i int) interface{} {
		...
		file_keyforge_proto_msgTypes[5].Exporter = func(v interface{}, i int) interface{} {
